...
function ShowResult(){
    ...
    resultText.textContent = `Правильных ответов: ${correct} из ${question.length}`;

    reviewList.innerHTML ='';

    question.forEach((q,i)=>{
        const userIndex = userAnswer[i];
        const userText = userAnswer === null ? "нет ответа":q.options[userIndex];
